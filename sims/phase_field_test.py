...
if __name__ == "__main__":
    ...
    # image = cv2.imread('C:/Users/ndsch/PycharmProjects/LBM-NDS/src/masks/flow11.png', cv2.IMREAD_GRAYSCALE)
    ...
    # phi_init = phi_init.at[:, int(ny / 2):].set(0)
    phi_init = jnp.zeros((nx, ny))
    # phi_init = jnp.ones((nx, ny))
    # phi_init = place_circle(phi_init, radius, 0,)
